...
public class BoardRePository {
    ...
    //페이징네이션을 위한 매서드 : 확인필요!
    public int count(){
        Query query = em.createNativeQuery("select count(*) from taekawnBoard_tb");
    ...
    public List<Board> findAll(int page){
        ...
        Query query = em.createNativeQuery("select * form taekwanBoard_tb order by id desc limit?,?",Board.class);
